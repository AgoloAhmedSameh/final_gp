...
def install_dependencies():
    if platform.system() == "Windows":
        print("Warning: Coverage tools installation not supported on Windows.")
        print("Please install the following manually:")
        print("- g++ compiler (via MinGW or Visual Studio)")
        print("- Java Development Kit (JDK)")
        print("- Node.js")
        print("- JaCoCo coverage tool")
        return False
    else:
        try:
    ...
    try:
        if language == "cpp":
            ...
            try:
                ...
                return result['line'] if result else 0.0
            except Exception as e:
            ...
            try:
                ...
                return dic['line'] if dic else 0.0
            except Exception as e:
                print(f"Error processing java: {e}")
                return 0.0
        elif language == "javascript":
            try:
                dic = js_coverage(code, asserts)
                return dic["coverage_percentage"] if dic else 0.0
            except Exception as e:
            ...
            try:
                ...
                return dic["coverage"] if dic else 0.0
            except Exception as e:
                print(f"Error processing python: {e}")
                return 0.0
        else:
            print(f"Unsupported language: {language}")
            return 0.0
    except Exception as e:
        print(f"Unexpected error in calculate_coverage: {e}")
        return 0.0
